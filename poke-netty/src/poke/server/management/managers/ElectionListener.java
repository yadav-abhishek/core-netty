...
public class ElectionListener implements MonitorListener {
	protected static Logger logger = LoggerFactory.getLogger("management");

	private ElectionData data;

	public ElectionListener(ElectionData data) {
		this.data = data;
	}
	...
	public void onMessage(eye.Comm.Management msg) {
		...
		logger.info("Received election responses Election listener onMessage");
		...
		/*if (msg.hasGraph()) {
			...
			logger.info("Received heartbeatMgr from on wrong channel or unknown host: " + msg.getBeat().getNodeId());
		*/
	}
