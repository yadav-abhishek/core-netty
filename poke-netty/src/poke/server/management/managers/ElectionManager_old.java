 ...
 * 
 */
public class ElectionManager_old {
	protected static Logger logger = LoggerFactory.getLogger("management");
	protected static AtomicReference<ElectionManager_old> instance = new AtomicReference<ElectionManager_old>();
	ConcurrentHashMap<Channel, ElectionData> outgoingHB = new ConcurrentHashMap<Channel, ElectionData>();
	ConcurrentHashMap<String, ElectionData> incomingHB = new ConcurrentHashMap<String, ElectionData>();
	private String nodeId;

	/** @brief the number of votes this server can cast */
	private int votes = 1;

	public static ElectionManager_old getInstance(String id, int votes) {
		instance.compareAndSet(null, new ElectionManager_old(id, votes));
		return instance.get();
	}

	public static ElectionManager_old getInstance() {
		return instance.get();
	}
	 ...
	 */
	protected ElectionManager_old(String nodeId, int votes) {
		this.nodeId = nodeId;
